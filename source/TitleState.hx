...
class TitleState extends MusicBeatState
{
	...
	public static var fromLang:Bool = false;
	public static var muteKeys:Array<FlxKey> = [FlxKey.ZERO, FlxKey.F9];
	public static var volumeDownKeys:Array<FlxKey> = [FlxKey.NUMPADMINUS, FlxKey.MINUS, FlxKey.F10];
	public static var volumeUpKeys:Array<FlxKey> = [FlxKey.NUMPADPLUS, FlxKey.PLUS, FlxKey.F11];
	...
	override public function create():Void
	{
		...
		if (fromLang == false) {
			...
			FlxG.switchState(new LanguageSelectionState()); }
	...
	function startIntro()
	{
		...
		blackScreen = new FlxSprite().makeGraphic(FlxG.width, FlxG.height, FlxColor.GRAY);
		...
		logoSpr = new FlxSprite(0, 0).loadGraphic(Paths.image('titlelogo'));
	...
	override function update(elapsed:Float)
	{
		...
		if (pressedEnter && !transitioning && skippedIntro)
		{
			...
			new FlxTimer().start(0.8, function(tmr:FlxTimer)
			{
				...
				//FlxTween.tween(blackScreen, {y: 1000}, 1.2, {ease: FlxEase.expoInOut});
	...
	{
		FlxTween.tween(logoBl, {y: 200}, 0.3);
		new FlxTimer().start(0.8, function(swagTimer:FlxTimer)
		{
			FlxTween.tween(logoBl, {y: 0}, 0.1);
		});
