...
class Controls extends FlxActionSet
{
	...
	var _gimmick = new FlxActionDigital(Action.GIMMICK_KEY);
	...
	inline function get_GIMMICK_KEY()
		return _gimmick.check();
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			...
			case GIMMICK_KEY:
				func(_gimmick, JUST_PRESSED);
				func(_gimmick, JUST_PRESSED);
				func(_gimmick, JUST_RELEASED);
		}
	}
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.GIMMICK_KEY, [SPACE]);
			case Duo(true):
		...
		switch (scheme)
		{
			case Solo:
				...
				bindKeys(Control.GIMMICK_KEY, [SPACE]);
			case Duo(true):
